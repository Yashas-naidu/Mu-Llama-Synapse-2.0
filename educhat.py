...
FRAME_EXTRACTION_DIRECTORY = "/workspaces/Frames"
FRAME_PREFIX = "_frame"
...
if option == 'Audio':
    ...
    if uploaded_file is not None:
        ...
        for prompt, response in reversed(st.session_state.prompts1):
    ...
    files = glob.glob('/workspaces/Frames*.jpg')
    for f in files:
        os.remove(f)
    ...
    if uploaded_file is not None:
        ...
        for file in files_to_upload if full_video else files_to_upload[0:200]:
